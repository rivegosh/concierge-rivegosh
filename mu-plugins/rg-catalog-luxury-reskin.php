 ...
 * ║  ───────────────────────────────────────────────────────────────  ║
 * ║  v2.0.0 DOM-verified on Florida destination sub-page 2026-04-19  ║
 * ║                                                                   ║
 * ║  WHAT THIS FILE COVERS (all DOM-verified):                        ║
 * ║  · Colibri h-text description paragraphs → white, 680px centered ║
 * ║  · body dark (#1A1A1A) on Amelia pages + body.page-id-44401      ║
 * ║  · am-fcil__item-name (service card titles) → white              ║
 * ║  · am-fcis__header-name (service detail title) → champagne gold  ║
 * ║    3-class specificity beats Amelia's own var(--am-c-main-text)   ║
 * ║  · Service/Package badge el-tags → champagne (not green)         ║
 * ║  · --am-c-main-bgr STAYS #0f0c08 — changing it kills car images  ║
 * ║    (Amelia uses this var for gallery-hero background, dark car    ║
 * ║    cutouts need dark field — b3a11ac proved this the hard way)    ║
 * ║                                                                   ║
 * ║  If Amelia catalog or service-detail views look wrong later,      ║
 * ║  FIX THE CAUSE — do NOT edit this file. Ship additive overrides  ║
 * ║  in a NEW mu-plugin if needed.                                    ║
 * ║                                                                   ║
 * ║  WHY THIS FILE EXISTS: Prior dark luxury reskin was lost when     ║
 * ║  concurrent CC sessions deleted the mu-plugins. LiteSpeed cache   ║
 * ║  masked the absence until 2026-04-19 cache purge revealed it.    ║
 * ║                                                                   ║
 * ║  GitHub: rivegosh/concierge-rivegosh#82                          ║
 * ║  Commit of record: 8ee8645                                        ║
 * ╚══════════════════════════════════════════════════════════════════╝
 */
