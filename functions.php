...
function rivegosh_custom_drawer_v43() {
    ...
    if (empty($vip_kids)) {
        $vip_kids = [
            ...
            ['title' => 'My Transfers', 'url' => '/my-orders/',   'vis' => 'member'],
            ['title' => 'My Chauffeur', 'url' => '/booking-vip/', 'vis' => 'member'],
...
function rivegosh_portal_sidebar_v2() {
  ...
  $nav = [
    ...
    ['label' => 'MY TRANSFERS',     'url' => '/my-orders/',   'id' => 16,    'vis' => 'member'],
    ['label' => 'MY CHAUFFEUR',     'url' => '/booking-vip/', 'id' => 54773, 'vis' => 'member'],
