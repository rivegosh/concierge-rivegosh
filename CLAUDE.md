...
| `mu-plugins/rg-appointment-gallery-hide.php` | 1.2.0 | [88aa3c3](https://github.com/rivegosh/concierge-rivegosh/commit/88aa3c3) | [#82](https://github.com/rivegosh/concierge-rivegosh/issues/82) | Hides .am-fcis__gallery + .am-fcip__gallery on /appointment/ (ID 44401). Nuclear CSS specificity (1,3,1) + JS MutationObserver with `style.setProperty('display','none','important')` — immune to all CSS battles. |
