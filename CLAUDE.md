...
| `mu-plugins/rg-appointment-gallery-hide.php` | 1.1.0 | [af33850](https://github.com/rivegosh/concierge-rivegosh/commit/af33850) | [#82](https://github.com/rivegosh/concierge-rivegosh/issues/82) | Hides .am-fcis__gallery + .am-fcip__gallery on /appointment/ (ID 44401). 54/55 services have 1 photo; gallery shows as dead empty area. Uses `.amelia-v2-booking` parent (specificity 0,2,0) to beat rg-amelia-contrast.php's competing `display:flex !important` on the same element. |
