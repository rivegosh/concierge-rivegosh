...
| `mu-plugins/rg-wizard-continue-btn.php` | 1.0.0 | [adccbf5](https://github.com/rivegosh/concierge-rivegosh/commit/adccbf5) | — | CONTINUE button in Amelia booking wizard (.am-fs__main-footer .am-button-continue): min-width 240px (was ~117px), font-size 13px (was 11px), font-weight 700, color #0a0a0a. Footer min-height 74px prevents layout jitter when Cart step adds a second "Book another" button. Priority 100007. |
