...
| `mu-plugins/rg-appointment-redesign.php` | 1.2.2 | [c76368a](https://github.com/rivegosh/concierge-rivegosh/commit/c76368a) | [#80](https://github.com/rivegosh/concierge-rivegosh/issues/80) | Skins /appointment/ page (ID 44401) — vertical stepper (number + label + representative SVG icon) + 11 destination cards with champagne-gold hairline + centered airplane icons. Missed by #68 Amelia reskin (targeted 61860-c2 home, not 44401-*). Scope-guarded via is_page( 44401 ) — zero bleed. |
