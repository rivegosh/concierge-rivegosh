...
| `mu-plugins/rg-catalog-luxury-reskin.php` | 1.0.0 | [18ca4cf](https://github.com/rivegosh/concierge-rivegosh/commit/18ca4cf) | [#82](https://github.com/rivegosh/concierge-rivegosh/issues/82) | Restores dark luxury for Amelia catalog form on /appointment/ (ID 44401): transparent container backgrounds, champagne body copy (14px, max-width 640px), dark-glass service cards, gallery hero with contain sizing (no cropping), gallery btn/thumbs hidden. Companion to rg-appointment-redesign.php. |
